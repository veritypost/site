...
// GET /api/kids/household-kpis
// Rolling 7-day household rollup for the parental dashboard hero:
//   - articles:        reading_log completions across the family
//   - minutes:         sum of reading_log.time_spent_seconds / 60
//   - quizzes_passed:  distinct (actor, article, attempt) with >= 3 correct
//   - longest_streak:  max(streak_current) + member label
//
// Family membership = owner + any co-adult currently active under the
// owner's plan (subscriptions.family_owner_id = owner_id, status=active)
// + all of the owner's kid_profiles.
