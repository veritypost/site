...
export async function POST(request) {
  try {
    ...
    // DA-109 / F-085: hash with PBKDF2-SHA256 + fresh per-row salt. Old
    // unsalted SHA-256 rows are kept functional via the legacy path in
    // lib/kidPin; any set-pin call rotates to pbkdf2 immediately.
