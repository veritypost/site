...
// Streak celebration ribbon. Shown on the kid home when the active
// kid has an ongoing streak. Tone shifts at 3 days: muted warm for
// 1-2, full streak orange + flame for 3+. At 0 we don't render (the
// caller is responsible; the ribbon is a celebration, not a zero-
// state). Ink text on the warm surface per the KID contrast guidance.

export default function StreakRibbon({ days, name }) {
