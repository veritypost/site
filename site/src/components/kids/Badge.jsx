...
// Shared kid-mode achievement badge. Gold ring, star glyph, name.
// Used on the kid-facing profile badges grid AND on the parental
// per-kid dashboard so parent + kid see the same moment of pride.

export default function Badge({ name, subdued = false }) {
