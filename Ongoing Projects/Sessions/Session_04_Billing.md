...
- **Status:** 🟦 open. **Split:** RPC body in S1, route caller in S4.
...
- **Status:** 🟦 open. **Code-half ships behind a feature flag, OFF by default. Flag-flip waits for owner-paired test on a real test family account.**
...
- **Status:** 🟦 open. **Code-half ships behind a feature flag, OFF by default. Flag-flip waits for owner-paired test.**
- **Files:**
...
- **Status:** 🟨 depends on S1-T2.7 RPC migration
- **Files:**
...
- **Status:** 🟦 verify-only here (bible work itself ships in S6)
- **File:line:**
