-- Patch post_comment: skip quiz gate for owner accounts.
-- v_user is already loaded from public.users; email check adds no extra query.
...
BEGIN
  ...
  -- Quiz gate: skipped for owner accounts (god-mode bypass).
