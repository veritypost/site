...
| 5 | `web/src/app/profile/[id]/page.tsx:353-411` | `handleFollow` + `handleBlock` write to `follows`/`blocked_users` direct via RLS client. Bypasses rate limit, email-verified gate, audit, perm gate. | A+C+D + settings |
