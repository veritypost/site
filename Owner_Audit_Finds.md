...
- **Ready for fix:** n/a — shipped 2026-05-03 `6d46831`
...
- **pipeline-data:** #2 (sources "Unknown") — shipped 2026-05-03 `6d46831` (writers + render + iOS + backfill migration). **Owner action:** apply `supabase/migrations/20260503000007_backfill_unknown_sources_to_null.sql` to clear the 4 existing rows (MCP server here is read-only, couldn't run it).
