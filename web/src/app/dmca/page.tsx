    ...
    <div style={{ minHeight: '100vh', background: '#ffffff', padding: '20px' }}>
      <div style={{ maxWidth: '640px', margin: '0 auto' }}>
        ...
        <div style={sectionStyle}>
          <p style={textStyle}>
            Verity Post respects the intellectual property rights of others and expects its users to
        ...
        <div style={sectionStyle}>
          ...
          <p style={textStyle}>
            ...
            infringement, please provide the following information to our designated agent:
          </p>
          <ul style={listStyle}>
            ...
            <li>
              ...
              locate it on our platform (e.g., a URL).
            </li>
            <li>
        ...
        <div style={sectionStyle}>
          ...
          <p style={textStyle}>
            ...
            and restore the material within 10 to 14 business days unless the complainant files a
            court action.
          </p>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <p style={textStyle}>
            Verity Post maintains a policy of terminating accounts of users who are repeat copyright
            infringers. Users who receive three valid DMCA takedown notices will have their accounts
