...
type ArticleRow = Pick<Tables<'articles'>, 'id' | 'title' | 'slug' | 'category_id' | 'published_at'>;
...
export default function BrowsePage() {
  ...
  const shell: CSSProperties = { background: PALETTE.bg, minHeight: '100vh', fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif', color: PALETTE.text };
