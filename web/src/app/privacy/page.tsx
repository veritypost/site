      ...
      <div style={{ maxWidth: '640px', margin: '0 auto' }}>
        ...
        <div style={sectionStyle}>
          <p style={{ fontSize: '14px', color: '#111111', lineHeight: '1.8', margin: 0 }}>
            Verity Post is operated by Verity Post LLC, which acts as the data controller for
            personal information processed through the platform. This policy explains what we
        ...
        <div style={sectionStyle}>
          ...
          <ul style={listStyle}>
            <li>
              Account information: email address, username, password hash, and profile details you
              choose to provide.
            </li>
            <li>
              Usage data: pages visited, articles read, quiz scores, Verity Score interactions, and
        ...
        <div style={sectionStyle}>
          ...
          <ul style={listStyle}>
            <li>
              To provide, maintain, and improve the Verity Post platform and personalize your
              experience.
            </li>
            <li>
        ...
        <div style={sectionStyle}>
          ...
          <ul style={listStyle}>
            ...
            <li>
              ...
              individual data is anonymized before use.
            </li>
          </ul>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <ul style={listStyle}>
            ...
            <li>
              We may share anonymized, aggregate data with research partners studying media literacy
              and misinformation.
            </li>
            <li>
              We use essential service providers (hosting, email delivery, payment processing) who
              are bound by data protection agreements.
            </li>
            <li>
              We may disclose information when required by law or to protect the safety of our
              users.
            </li>
          </ul>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <ul style={listStyle}>
            ...
            <li>
              After account deletion, personal data is purged within 30 days, except where retention
              is required by law.
            </li>
            <li>
              Anonymized usage data may be retained indefinitely for research and platform
              improvement.
            </li>
          </ul>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <ul style={listStyle}>
            <li>
              Verity Post uses Google AdSense to display advertisements. Google and its third-party
              vendors may use cookies and similar technologies to serve ads based on your prior
              visits to this site and other sites.
            </li>
            <li>
              You can opt out of personalized advertising by visiting Google&apos;s Ads Settings at
              https://adssettings.google.com, or learn more about how Google uses data from sites
              that use its services at https://policies.google.com/technologies/partner-sites.
            </li>
            <li>
              For details on Google&apos;s advertising technologies and cookies, see
        ...
        <div style={sectionStyle}>
          ...
          <ul style={listStyle}>
            <li>
              You may access, correct, or delete your personal data at any time through your account
              settings.
            </li>
            <li>
