...
export default function ContactPage() {
  ...
  const canSubmit = Boolean(topic && subject.trim() && body.trim() && email.trim() && email.includes('@'));
    ...
    <div style={{ minHeight: '100vh', background: '#ffffff', padding: '20px' }}>
      <div style={{ maxWidth: 640, margin: '0 auto' }}>
        <a href="/" style={{
          ...
          color: '#666666', textDecoration: 'none', marginBottom: 16,
        }}>Back to home</a>

        <h1 style={{ fontSize: 28, fontWeight: 800, color: '#111111', margin: '0 0 8px', letterSpacing: '-0.02em' }}>Contact us</h1>
        <p style={{ fontSize: 15, color: '#666666', margin: '0 0 24px', lineHeight: 1.6 }}>
          Have a question or need help? Send us a message and we will reply to the email address you provide.
        </p>

        {loggedIn && !submitted && (
          <div style={{
            padding: '12px 14px', borderRadius: 10, marginBottom: 20,
            background: '#f0f7ff', border: '1px solid #c7dcf0', color: '#0b4a8f', fontSize: 13,
          }}>
            Signed in? Sending from{' '}
            <a href="/profile/contact" style={{ color: '#0b4a8f', fontWeight: 700, textDecoration: 'underline' }}>your account contact form</a>
        ...
        {submitted ? (
          <div style={{
            padding: 24, borderRadius: 12, border: '1px solid #e5e5e5',
            background: '#f7f7f7', textAlign: 'center',
          }}>
            <div style={{ fontSize: 16, fontWeight: 700, color: '#111111', marginBottom: 8 }}>Message sent</div>
            ...
            <button
              ...
              style={{
                padding: '10px 20px', borderRadius: 8, border: '1px solid #111111',
                background: '#ffffff', color: '#111111', fontSize: 13, fontWeight: 600,
                cursor: 'pointer',
              }}
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            {/* Topic */}
            <div>
              <label style={{ display: 'block', fontSize: 13, fontWeight: 600, color: '#111111', marginBottom: 6 }}>Topic</label>
            ...
            {/* Email */}
            <div>
              <label style={{ display: 'block', fontSize: 13, fontWeight: 600, color: '#111111', marginBottom: 6 }}>Your email</label>
              <input
                type="email"
                value={email}
            ...
            {/* Subject */}
            <div>
              <label style={{ display: 'block', fontSize: 13, fontWeight: 600, color: '#111111', marginBottom: 6 }}>Subject</label>
              <input
                value={subject}
            ...
            {/* Body */}
            <div>
              <label style={{ display: 'block', fontSize: 13, fontWeight: 600, color: '#111111', marginBottom: 6 }}>Message</label>
              <textarea
                value={body}
