...
export default function ReceiptMockup() {
  ...
  SINCE  Apr 20, 9:14 am ET`}
          ...
          >
            <strong style={{ color: T.text }}>The design move:</strong> a monospaced receipt at the
            end of every finished article. Becomes a tiny civic-feeling artifact — shareable without
            being gamified. Click <em>copy receipt</em> to see the plain-text version.
          </div>
        </article>
      </div>
    </main>
