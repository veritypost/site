    ...
    >
      <div style={{ maxWidth: 680, margin: '0 auto' }}>
        ...
        <p style={{ fontSize: 15, color: S.dim, lineHeight: 1.6, marginBottom: 56 }}>
          Each mockup stands alone. Click through to see them rendered with sample data. None of
          these have shipped yet — they exist here to evaluate, not to approve. Full design notes in{' '}
          <code
            style={{ fontSize: 13, background: '#f3f3f3', padding: '2px 6px', borderRadius: 4 }}
          >
            proposedideas/
          </code>{' '}
          on disk.
            ...
            >
              ...
              >
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <div style={{ fontSize: 14, color: S.dim, lineHeight: 1.5 }}>{item.hook}</div>
                </div>
