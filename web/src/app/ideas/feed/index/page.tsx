    ...
    >
      <div style={{ maxWidth: 560, margin: '0 auto', textAlign: 'center', marginBottom: 32 }}>
        ...
        <div style={{ fontSize: 13, color: T.textDim, lineHeight: 1.55 }}>
          Magazine TOC paradigm. Department-grouped, image-free, pure typographic hierarchy. No
          editor\u2019s argument at the top \u2014 which is the tradeoff.
        </div>
      </div>
      ...
      <div style={{ display: 'flex', justifyContent: 'center' }}>
        <PhoneFrame>
          ...
          <div style={{ padding: '32px 24px 80px', textAlign: 'center' }}>
            <div
              style={{ fontSize: 12, color: T.textMute, fontFamily: T.serif, fontStyle: 'italic' }}
            >
