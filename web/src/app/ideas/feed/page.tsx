  ...
  return (
    <main style={{
      ...
      <div style={{ maxWidth: 920, margin: '0 auto' }}>
        <a href="/ideas" style={{ display: 'inline-block', fontSize: 12, color: T.textDim, marginBottom: 32, textDecoration: 'none' }}>
          ← back to ideas
        </a>

        <div style={{ fontSize: 11, letterSpacing: '0.12em', textTransform: 'uppercase', color: T.textDim, marginBottom: 16 }}>
        ...
        <p style={{ fontSize: 15, color: T.textDim, lineHeight: 1.6, marginBottom: 48, maxWidth: 620 }}>
          Each prototype renders on a true-scale iPhone viewport (390 × 844pt) so typography, measure, and density reflect what ships. The editorial sequence, dek text, and bylines are identical across all five \u2014 only the interface changes. Every proposal preserves headline + summary as invariants.
        </p>

        <div style={{ borderTop: `1px solid ${T.ruleSoft}` }}>
          {protos.map(p => (
            <a key={p.slug} href={`/ideas/feed/${p.slug}`} style={{
              display: 'block',
              padding: '28px 0',
              ...
              <div style={{ display: 'flex', gap: 24, alignItems: 'baseline' }}>
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <div style={{ fontSize: 12, color: T.textMute, letterSpacing: '0.04em', marginBottom: 8, fontFamily: T.mono }}>
                    {p.paradigm}
                  </div>
        ...
        <div style={{ marginTop: 56, fontSize: 13, color: T.textDim, lineHeight: 1.6 }}>
          <strong style={{ color: T.text }}>How to look at these.</strong> Open each in a tab, scroll inside the phone frame, and compare the same 14 stories under each paradigm. Full research memo + decision matrix in the message that generated these; the short version is that P2 is the recommendation and P1 becomes its tail.
        </div>
      </div>
    </main>
  );
