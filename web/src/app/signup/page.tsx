      ...
      <div style={{
        ...
        <form onSubmit={handleSubmit} aria-describedby={error ? 'signup-form-error' : undefined}>
          <div style={{ marginBottom: '14px' }}>
            ...
            {emailCheck.status === 'taken' && <div style={{ fontSize: 11, color: '#ef4444', marginTop: 4 }}>An account already exists for that email. <a href={`/login?email=${encodeURIComponent(email)}`} style={{ color: '#ef4444', fontWeight: 600, textDecoration: 'underline' }}>Sign in instead</a>.</div>}
          </div>
