  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* SSO (Apple + Google) hidden during closed beta — same launch-hide
            pattern as /login. To re-enable: restore the two button blocks
            and the "or" divider. The startOAuth handler stays in place. */}
