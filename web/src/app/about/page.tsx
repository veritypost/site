...
export const metadata: Metadata = {
  ...
  description:
    'Verity Post is a news platform where the discussion section is earned. Operated by Verity Post LLC.',
};
    ...
    <div style={{ minHeight: '100vh', background: '#ffffff', padding: '20px' }}>
      <div style={{ maxWidth: '640px', margin: '0 auto' }}>
        ...
        <Section title="What we are">
          <p style={textStyle}>
            Verity Post is a news platform where the discussion section is earned. Every article has
            a short comprehension quiz, and commenters unlock the discussion by showing they read
            the piece. The goal is a comment section worth reading — one where every voice in the
            thread has demonstrably engaged with the article first.
          </p>
        </Section>
        ...
        <Section title="Company">
          <p style={textStyle}>
            Verity Post is operated by <strong>Verity Post LLC</strong>, a United States limited
            liability company. Verity Post LLC owns and operates the Verity Post website.
          </p>
        </Section>
