...
/**
 * NEW Newsroom (Decision 4) — Discovery + Articles tabs.
 *
 * Mounted only when NEXT_PUBLIC_NEWSROOM_V2=1 (page.tsx switches between
 * legacy and v2). Old admin/newsroom/page.tsx implementation is
 * untouched in Session B.
 *
 * URL state:
 ...
 *   ?q=…
 *
 * Tabs/panels intentionally piggyback on the existing client-side admin
 * role gate the legacy page already enforces — server-side route auth
 * is the real gate. Permission checks for individual mutations live on
 * the API routes via requirePermission dual-check.
 */
