  ...
  public: {
    Tables: {
      ...
      ad_freq_counters: {
        ...
        Relationships: [
          {
            foreignKeyName: "ad_freq_counters_ad_unit_id_fkey"
            columns: ["ad_unit_id"]
            isOneToOne: false
            referencedRelation: "ad_units"
            referencedColumns: ["id"]
      ...
      ad_pins: {
        ...
        Relationships: [
          {
            foreignKeyName: "ad_pins_ad_unit_id_fkey"
            columns: ["ad_unit_id"]
            isOneToOne: false
            referencedRelation: "ad_units"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "ad_pins_pinned_by_fkey"
            columns: ["pinned_by"]
            isOneToOne: false
            referencedRelation: "public_profiles_v"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "ad_pins_placement_id_fkey"
            columns: ["placement_id"]
            isOneToOne: true
            referencedRelation: "ad_placements"
            referencedColumns: ["id"]
      ...
      ad_target_geo: {
        ...
        Relationships: [
          {
            foreignKeyName: "ad_target_geo_ad_unit_id_fkey"
            columns: ["ad_unit_id"]
            isOneToOne: false
            referencedRelation: "ad_units"
            referencedColumns: ["id"]
      ...
      admin_alerts: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "admin_alerts_report_id_fkey"
            columns: ["report_id"]
            isOneToOne: false
      ...
      comment_followups: {
        ...
        Relationships: [
          {
            foreignKeyName: "comment_followups_comment_id_fkey"
            columns: ["comment_id"]
            isOneToOne: false
            referencedRelation: "comments"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "comment_followups_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "public_profiles_v"
            referencedColumns: ["id"]
      ...
      comments: {
        ...
        Relationships: [
          {
            foreignKeyName: "comments_expert_thread_closed_by_fkey"
            columns: ["expert_thread_closed_by"]
            isOneToOne: false
            referencedRelation: "public_profiles_v"
            referencedColumns: ["id"]
          },
          ...
          {
            foreignKeyName: "comments_expert_thread_root_id_fkey"
            columns: ["expert_thread_root_id"]
            isOneToOne: false
            referencedRelation: "comments"
            referencedColumns: ["id"]
          },
      ...
      editors_edge_picks: {
        ...
        Relationships: [
          {
            foreignKeyName: "editors_edge_picks_article_id_fkey"
            columns: ["article_id"]
            isOneToOne: false
            referencedRelation: "articles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "editors_edge_picks_category_id_fkey"
            columns: ["category_id"]
            isOneToOne: false
            referencedRelation: "categories"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "editors_edge_picks_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "public_profiles_v"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "editors_edge_picks_subcategory_id_fkey"
            columns: ["subcategory_id"]
            isOneToOne: false
            referencedRelation: "categories"
            referencedColumns: ["id"]
      ...
      expert_applications: {
        Row: {
          ...
          id: string
          last_quiet_hours_digest_at: string | null
      ...
      expert_mention_post_counters: {
        ...
        Relationships: [
          {
            foreignKeyName: "expert_mention_post_counters_article_id_fkey"
            columns: ["article_id"]
            isOneToOne: false
            referencedRelation: "articles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "expert_mention_post_counters_expert_user_id_fkey"
      ...
      expert_mention_quota_counters: {
        ...
        Relationships: [
          {
            foreignKeyName: "expert_mention_quota_counters_expert_user_id_fkey"
            columns: ["expert_user_id"]
            isOneToOne: false
            referencedRelation: "public_profiles_v"
            referencedColumns: ["id"]
      ...
      expert_thread_chains: {
        ...
        Relationships: [
          {
            foreignKeyName: "expert_thread_chains_asker_user_id_fkey"
          ...
          {
            foreignKeyName: "expert_thread_chains_expert_user_id_fkey"
            columns: ["expert_user_id"]
            isOneToOne: false
            referencedRelation: "public_profiles_v"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "expert_thread_chains_free_pass_granted_by_fkey"
            columns: ["free_pass_granted_by"]
            isOneToOne: false
            referencedRelation: "public_profiles_v"
            referencedColumns: ["id"]
          },
          ...
          {
            foreignKeyName: "expert_thread_chains_thread_root_id_fkey"
      ...
      score_events: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "fk_score_events_kid_profile_id"
            columns: ["kid_profile_id"]
            isOneToOne: false
            referencedRelation: "kid_profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "fk_score_events_user_id"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "public_profiles_v"
            referencedColumns: ["id"]
      ...
      story_follows: {
        ...
        Relationships: [
          {
            foreignKeyName: "story_follows_kid_profile_id_fkey"
            columns: ["kid_profile_id"]
            isOneToOne: false
            referencedRelation: "kid_profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "story_follows_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "public_profiles_v"
            referencedColumns: ["id"]
      ...
      story_resources: {
        ...
        Relationships: [
          {
            foreignKeyName: "story_resources_story_id_fkey"
            columns: ["story_id"]
            isOneToOne: false
            referencedRelation: "stories"
            referencedColumns: ["id"]
      ...
      user_topics_known: {
        ...
        Relationships: [
          {
            foreignKeyName: "user_topics_known_category_id_fkey"
            columns: ["category_id"]
            isOneToOne: false
            referencedRelation: "categories"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "user_topics_known_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "public_profiles_v"
            referencedColumns: ["id"]
      ...
      users: {
        Row: {
          ...
          background_lived_public: boolean
          ...
          quizzes_completed_count: number
          reading_default_mode: string
          reading_text_size: string
          reading_theme: string
          referral_code: string | null
          referred_by: string | null
          show_activity: boolean
          show_contributions_publicly: boolean
    ...
    Views: {
      ...
      public_profiles_v: {
        Row: {
          ...
          context_added_count: number | null
          ...
          show_contributions_publicly: boolean | null
    ...
    Functions: {
      ...
      add_kid_with_seat_check: {
        Args: {
          p_avatar_color: string
          p_date_of_birth: string
          p_display_name: string
          p_extra_kid_price_cents: number
          p_max_daily_minutes: number
          p_max_kids: number
          p_metadata: Json
          p_parent_user_id: string
          p_pin_hash: string
          p_pin_hash_algo: string
          p_pin_salt: string
      ...
      bump_expert_config_version: { Args: never; Returns: undefined }
      ...
      check_expert_mention_quota: {
        Args: { p_article_id: string; p_target_user_ids: string[] }
        Returns: Json
      }
      check_rate_limit: {
      ...
      expire_elapsed_mutes: { Args: never; Returns: undefined }
      ...
      grant_expert_thread_free_pass: {
        Args: {
          p_asker_user_id: string
          p_granting_expert_id: string
          p_thread_root_id: string
        }
        Returns: undefined
      }
      grant_pro_to_cohort: {
      ...
      is_kid_delegated_and_active: { Args: never; Returns: boolean }
      ...
      is_parent_elevated: { Args: never; Returns: boolean }
      is_parent_elevated_live: { Args: never; Returns: boolean }
      ...
      mark_story_seen:
        | { Args: { p_story_id: string }; Returns: undefined }
        | {
            Args: { p_story_id: string; p_user_id: string }
            Returns: undefined
          }
      mark_story_seen_kid: {
        Args: { p_kid_profile_id: string; p_story_id: string }
        Returns: undefined
      }
      merge_clusters: {
      ...
      set_expert_availability: {
        Args: {
          ...
          p_pause_until_indefinite: boolean
          p_qh_days: number[]
          p_qh_end: string
          p_qh_start: string
          p_vacation_until: string
        }
        Returns: undefined
      }
      ...
      sweep_failed_escalations: { Args: never; Returns: Json }
      ...
      user_received_upvote_category_tally: {
        Args: { p_user_id: string }
        Returns: {
          category_id: string
          n: number
