...
export const REQUEST_CONFIRM_TEMPLATE = {
  subject: `Confirm your email — ${BRAND_NAME_LOWER} beta access`,
...
<html><body style="margin:0;padding:0;background:#fafafa;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;color:#111;">
  <div style="max-width:560px;margin:0 auto;padding:32px 20px;">
    <div style="font-size:12px;font-weight:700;letter-spacing:0.16em;text-transform:uppercase;color:#6b7280;margin-bottom:16px;">${BRAND_NAME_LOWER}</div>
    ...
    <p style="font-size:15px;line-height:1.55;color:#374151;margin:0 0 16px 0;">
      You requested access to the ${BRAND_NAME_LOWER} beta. Click the button below to confirm this is your email — that&rsquo;s when your request goes to the team for review.
    </p>
  ...
  body_text: `${BRAND_NAME_LOWER} — Confirm your email.

You requested access to the ${BRAND_NAME_LOWER} beta. Click the link below to confirm this is your email — that's when your request goes to the team for review.
