...
export class CostCapExceededError extends Error {
  constructor(msg: string, public estimated_usd: number, public cap_usd: number) {
    super(msg);
    this.name = 'CostCapExceededError';
  }
}
export class ProviderAPIError extends Error {
  constructor(msg: string, public status?: number, public provider?: Provider) {
    super(msg);
    this.name = 'ProviderAPIError';
  }
}
export class RetryExhaustedError extends Error {
  constructor(msg: string, public lastError: unknown) {
    super(msg);
