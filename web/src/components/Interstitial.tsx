      ...
      >
        ...
        {variant === 'signup' ? (
          <div style={{ textAlign: 'center' }}>
            ...
            <a href={ctaHref} style={ctaStyle}>Create free account</a>
            <div style={{ marginTop: 10 }}>
              <button onClick={onClose} style={linkBtnStyle}>Maybe later</button>
            </div>
          </div>
        ) : (
          <div>
            ...
            <div style={{ textAlign: 'center', marginTop: 8 }}>
              <button onClick={onClose} style={linkBtnStyle}>Continue</button>
            </div>
          </div>
        )}
      </div>
