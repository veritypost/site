...
-- Migration: 20260419115025 restrict_users_table_privileged_inserts_2026_04_19
--
-- Close the BEFORE INSERT gap flagged by Round 4 final audit.
-- Extends reject_privileged_user_updates to also guard INSERTs so an attacker
-- cannot win a race against handle_new_auth_user and INSERT their own row
-- with privileged columns (is_expert, verity_score, plan_id, etc).
