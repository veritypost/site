-- Backup of settings.pipeline.prompt.* rows captured 2026-05-09 before
-- F8 Editorial Uplift Wave 2 DELETE. Rows were drifted overrides that
-- contradicted the editorial-guide.ts spec (kid/tween "why this matters"
-- closers, 70-word adult summaries, etc.). Restoring this file would
-- re-introduce the drift. Use only as emergency rollback if Wave 1
-- prompt rules need to be reverted in production.
--
-- Restore: psql ... < backup-pipeline-prompts-2026-05-09.sql

INSERT INTO settings (key, value) VALUES ('pipeline.prompt.adult.body', $vp$You are a wire service journalist writing for Verity Post.
...
250, you probably left out something important. Never exceed 450.$vp$)
ON CONFLICT (key) DO UPDATE SET value = EXCLUDED.value;

INSERT INTO settings (key, value) VALUES ('pipeline.prompt.adult.headline', $vp$Generate a headline and summary for this news article.
...
INSERT INTO settings (key, value) VALUES ('pipeline.prompt.adult.quiz', $vp$Generate 5 Quick Check questions for readers. These should feel like a casual challenge — not a test. Use friendly, curious phrasing like "Did you catch..." or "What's the deal with..." instead of dry textbook style. Every question must be answerable from the article text alone.
...
INSERT INTO settings (key, value) VALUES ('pipeline.prompt.adult.timeline', $vp$You generate the timeline for a Verity Post story.
...
INSERT INTO settings (key, value) VALUES ('pipeline.prompt.kids.body', $vp$You are writing a news article for children aged 7-9. Not dumbing down — translating. Same facts, simpler language.
...
INSERT INTO settings (key, value) VALUES ('pipeline.prompt.kids.headline', $vp$Generate a headline and summary for an article aimed at children aged 7-9 (early-to-middle elementary readers).
...
INSERT INTO settings (key, value) VALUES ('pipeline.prompt.kids.quiz', $vp$Generate 5 Quick Check questions for children aged 7-9 about this article. Make it feel like a fun game, not a school test.
...
INSERT INTO settings (key, value) VALUES ('pipeline.prompt.kids.timeline', $vp$Generate a timeline for children aged 7-9 about this news story.
...
INSERT INTO settings (key, value) VALUES ('pipeline.prompt.tweens.body', $vp$You are writing a news article for tweens aged 10-12. Real news voice, just unpacked.
...
INSERT INTO settings (key, value) VALUES ('pipeline.prompt.tweens.headline', $vp$Generate a headline and summary for an article aimed at tweens aged 10-12 (upper elementary / middle school readers).
...
INSERT INTO settings (key, value) VALUES ('pipeline.prompt.tweens.quiz', $vp$Generate 5 Quick Check questions for tweens aged 10-12 about this article. Treats the reader as a competent reader.
...
INSERT INTO settings (key, value) VALUES ('pipeline.prompt.tweens.timeline', $vp$Generate a timeline for tweens aged 10-12 about this news story.
